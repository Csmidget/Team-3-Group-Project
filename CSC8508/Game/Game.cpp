...
void Game::InitWorld(std::string levelName) {
	...
	GameObject* testA = AddCubeToWorld(Vector3(0, 5, 0), Vector3(1, 1, 1));
	...
	physics->addhingeconstraint(testA->GetPhysicsObject()->body, Vector3(0.0f, 5.0f, 0.0f), Vector3(0.0f, 1.0f, 0.0f));
	//world->Start();
